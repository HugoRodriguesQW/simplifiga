...
export function IndexHead() {
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Encurtador de URL gratuito com nossa plataforma de gerenciamento de links. Crie, simplifique e compartilhe." />
      <meta name="robots" content="index, follow"/>

      {/* SEO - GOOGLE+ */}
      <meta itemProp="name" content="Simplifiga"/>
      <meta itemProp="description" content="Encurtador de URL gratuito com nossa plataforma de gerenciamento de links. Crie, simplifique e compartilhe."/>
      ...
      <meta property="og:description" content="Encurtador de URL gratuito com nossa plataforma de gerenciamento de links. Crie, simplifique e compartilhe."/>
